...
<body>
	...
	<header id="head" class="secondary" style="background-color: #680000;">
		...
		<div class="container-fluid" style="margin-top:10px;margin-left:82px;margin-right:450px;">
			<h1>HTML Fundamentals</h1><br><label>Interested in learning how to design a website using HTML tags, elements, and attributes? Then this learning game is for you! Our interactive HTML tutorial is comprised of carefully selected videos, quizzes, and checkpoints to ensure that you learn as much as possible, while also having as much fun as possible. This is accomplished through a series of entertaining exercises, along with plenty of hands-on practice in writing actual HTML code.You will also learn the fundamentals of web design, collect colorful points, and compete with other learners throughout the world.Our videos are informative and concise, our checkpoints are enjoyable and your learning is guaranteed.Learn while playing and play while learning with our HTML Tutorial! Whether you want to further your career or simply gain a new skill, this tutorial will work for you.</label><button onclick="location.href='../html/chapter1.php'" class="btn btn-block" style="background-color: darkred; color: white;">Start Learing>></button>
		</div>
		<div class="container-fluid" style="margin-left:82px;margin-right:450px;">
			...
			</ol><button onclick="location.href='purchase.php'" class="btn btn-block" style="background-color: darkred; color: white;">Purchase Now>></button><br>
			<button onclick="location.href='../download/index.php'" class="btn btn-block" style="background-color: darkred; color: white;">Download free E-Books</button><br>
		</div>
	<?php
		include "footer.php";
	?>
